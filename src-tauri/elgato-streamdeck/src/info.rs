...
/// Product ID of Stream Deck Mini Discord Edition
pub const PID_STREAMDECK_MINI_DISCORD: u16 = 0x00b3;
...
impl Kind {
    ...
    pub fn from_vid_pid(vid: u16, pid: u16) -> Option<Kind> {
        match vid {
            ELGATO_VENDOR_ID => match pid {
                ...
                PID_STREAMDECK_MINI_DISCORD => Some(Kind::MiniDiscord),
    ...
    pub fn product_id(&self) -> u16 {
        match self {
            ...
            Kind::MiniDiscord => PID_STREAMDECK_MINI_DISCORD,
    ...
    pub fn vendor_id(&self) -> u16 {
        match self {
            ...
            Kind::MiniDiscord => ELGATO_VENDOR_ID,
    ...
    pub fn key_image_format(&self) -> ImageFormat {
        match self {
            ...
            Kind::Mini | Kind::MiniMk2 | Kind::MiniDiscord | Kind::MiniMk2Module => ImageFormat {
                mode: ImageMode::BMP,
                size: (80, 80),
    ...
    pub fn blank_image(&self) -> Vec<u8> {
        match self {
            ...
            Kind::PlusXl => {
                // Generate a proper 112x112 all-black JPEG at quality 90,
                // matching the encoding used by convert_image_with_format().
                use image::{ColorType, DynamicImage};
                use image::codecs::jpeg::JpegEncoder;
                let img = DynamicImage::new_rgb8(112, 112);
                let pixels = img.into_rgb8().to_vec();
                let mut buf = Vec::new();
                let mut encoder = JpegEncoder::new_with_quality(&mut buf, 90);
                let _ = encoder.encode(&pixels, 112, 112, ColorType::Rgb8.into());
                buf
            }
        }
    }
